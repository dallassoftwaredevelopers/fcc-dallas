  ...
  return (
    <StaticContentLayout title="Useful Links" showConnectWith>
      <Row flexDirection="column">
        ...
        <ExternalLink href={SocialMediaLinks.YOUTUBE}>freeCodeCamp Dallas YouTube</ExternalLink>
        <Divider />
        <Heading>Educational</Heading>
        <ExternalLink href={EducationalLinks.FREECODECAMP}>Official freeCodeCamp Site</ExternalLink>
        <ExternalLink href={EducationalLinks.W3_SCHOOLS}>W3 Schools</ExternalLink>
