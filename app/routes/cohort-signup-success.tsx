...
const CohortSignUpSuccess = () => (
  <StaticContentLayout>
    ...
    <Divider />
    <P center>
      Thank you for Applying to fCC Dallas Cohorts. Expect an email from us
      soon!
    </P>
    <P center>
      Go ahead and join us on{' '}
      <ExternalLink href={SocialMediaLinks.DISCORD}>Discord</ExternalLink>.
      You'll need to be active there to get Cohort updates and to communicate
      with your team once the Cohort starts
    </P>
  </StaticContentLayout>
);
