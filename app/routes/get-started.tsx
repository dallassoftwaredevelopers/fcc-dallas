    ...
    <StaticContentLayout title="Get Started" showConnectWith wide>
      <ContentMarginsLayout>
        <Activity name="Learn to Code" img="/img/learning_1.svg">
          ...
          <P>
            When you first start learning to code, remember to be patient and
            don't be afraid to reach out for help. There will be times you feel
            overwhelmed and it's important to remember that it's normal to feel
            this way. Connecting with fellow learners can help you break down
            barriers.
          </P>
        </Activity>
        <Divider />
        <Activity name="Attend a Meetup" img="/img/meetup.svg" isLeft>
          ...
          <P>
            In the future, we intend to introduce workshops. These workshops
            will be targeted for different skill levels and will be a great way
            to push yourself in a workshop targeted for learners at your level.
          </P>
        </Activity>
        <Divider />
        <Activity name="Get and Give Feedback" img="/img/feedback.svg">
          ...
          <P>
            If you're further along, you may enjoy mentoring others who are
            trying to learn. Giving feedback is a great way to provide coaching.
            Whether you're brand new or a seasoned engineer, we hope you'll join
            us in building one another's skills.
          </P>
        </Activity>
        <Divider />
        <Activity name="Join a Cohort" img="/img/team.svg" isLeft>
          ...
          <P>
            We recommend that everyone give our cohorts program a shot. Building
            with others is a sure way to accelerate your growth once you're far
            enough along to begin building projects.
          </P>
        </Activity>
        <Divider />
        <Activity name="Contribute to our Site" img="/img/pair-programming.svg">
          <P>
            ...
            code submissions will go through a round of code review. The code
            review is a great way to get feedback and to interact with our team.
          </P>
        </Activity>
      </ContentMarginsLayout>
    </StaticContentLayout>
